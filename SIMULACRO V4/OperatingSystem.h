...
#define NUMBEROFQUEUES 2  //Ejercicio 11 de la V1 

#define SLEEPINGQUEUE //Ejercicio 5 de la V2  

#define MEMORYFULL -5  //Ejercicio 6 de la V4 
...
int OperatingSystem_GetExecutingProcessID(); //Ej 1 de la V2 
